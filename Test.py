...
def get_features(img_path):
    ...
    custom_conv = Conv2D(1024, (3, 3), activation='relu', name='custom_conv')(x)
    feature_extractor = Model(inputs=base_model.input, outputs=custom_conv)
...
feature = get_features("cda316de42d8d72000bd153a098cff9f.jpg")
area, cropped_lst = box_img("cda316de42d8d72000bd153a098cff9f.jpg",feature)
area, cropped_lst = sort_lst(area,cropped_lst)
detection(cropped_lst,"cda316de42d8d72000bd153a098cff9f.jpg")
